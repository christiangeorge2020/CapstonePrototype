...
#define AU_COCOA_VIEWFACTORY_NAME AUCocoaViewFactory_38AF52030D2C4F9BB238F61C222EB990
#define AU_COCOA_VIEW_NAME AUCocoaView_38AF52030D2C4F9BB238F61C222EB990
...
const char* kAAXBundleID = "rackafxuser.aax.CapstonePrototype.bundleID";
const char* kVST3BundleID = "rackafxuser.vst3.CapstonePrototype.bundleID";

// --- For AU: make sure BOTH the Plugin Target and the CocoaUI Target PRODUCT_BUNDLE_IDENTIFIER settings match these strings
const char* kAUBundleID = "rackafxuser.au.CapstonePrototype.bundleID";

// --- plugin NAME
/* AU only: this MUST EXACLTY match the Product Name in Build Settings for BOTH the CocoaUI and your Plugin Targets! */
const char* kPluginName = "CapstonePrototype";     // 31 chars max for AAX
const char* kShortPluginName = "CapstonePrototy";    // 15 chars max for AAX
const char* kAUBundleName = "CapstonePrototype";
...
// --- VST3 & AAX only
const int32_t kFourCharCode = '2020'; /// must be unique for each plugin in your company
...
const char* kVSTFUID = "{38AF5203-0D2C-4F9B-B238-F61C222EB990}"; /// NOTE: you need the enclosing { }

// --- AAX specific
const int32_t kManufacturerID = 'GRGE';
const int32_t kAAXProductID = '2020';
